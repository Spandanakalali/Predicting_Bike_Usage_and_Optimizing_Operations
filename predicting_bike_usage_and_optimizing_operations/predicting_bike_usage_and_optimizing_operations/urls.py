"""predicting_bike_usage_and_optimizing_operations  URL Configuration
...
from predicting_bike_usage_and_optimizing_operations  import settings
...
urlpatterns = [
    ...
    url(r'^predict_bike_usage_type/$', remoteuser.predict_bike_usage_type, name="predict_bike_usage_type"),
    ...
    url(r'^View_Predicted_Bike_Usage_Type_Ratio/$', serviceprovider.View_Predicted_Bike_Usage_Type_Ratio, name="View_Predicted_Bike_Usage_Type_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Predicted_Bike_Usage_Type/$', serviceprovider.View_Predicted_Bike_Usage_Type, name="View_Predicted_Bike_Usage_Type"),
