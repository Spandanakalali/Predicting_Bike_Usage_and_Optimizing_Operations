...
ROOT_URLCONF = 'predicting_bike_usage_and_optimizing_operations.urls'
...
WSGI_APPLICATION = 'predicting_bike_usage_and_optimizing_operations.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'predicting_bike_usage_and_optimizing_operations',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
