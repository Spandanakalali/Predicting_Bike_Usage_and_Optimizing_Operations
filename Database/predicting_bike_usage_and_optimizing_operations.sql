...
--
-- Host: localhost
-- Generation Time: Nov 10, 2023 at 01:56 PM
...
--
-- Database: `predicting_bike_usage_and_optimizing_operations`
--
CREATE DATABASE IF NOT EXISTS `predicting_bike_usage_and_optimizing_operations` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `predicting_bike_usage_and_optimizing_operations`;
...
('z004agdn3fyyp2poa1mc5zg0n9grc041', 'eyJ1c2VyaWQiOjR9:1r1Rte:AYOjSjwUbtmWP6ZkymOGpXlbySoDquv5DaJMqUxc6oU', '2023-11-24 13:50:06.853549'),
...
(3, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(4, 'Manjunath', 'tmksmanju14@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Vijayanagar', 'Male');
...
(10, 'Artificial Neural Network (ANN)', '48.30508474576271'),
(11, 'SVM', '52.90556900726392'),
(12, 'Random Forest Classifier', '50.96852300242131'),
(13, 'KNeighborsClassifier', '51.937046004842614'),
(14, 'Decision Tree Classifier', '50.847457627118644');
...
--
-- Table structure for table `remote_user_predicting_bike_usage`
--

CREATE TABLE IF NOT EXISTS `remote_user_predicting_bike_usage` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `trip_id` varchar(3000) NOT NULL,
  `starttime` varchar(3000) NOT NULL,
  `stoptime` varchar(3000) NOT NULL,
  `bikeid` varchar(3000) NOT NULL,
  `tripduration` varchar(3000) NOT NULL,
  `from_station_id` varchar(3000) NOT NULL,
  `from_station_name` varchar(3000) NOT NULL,
  `to_station_id` varchar(3000) NOT NULL,
  `to_station_name` varchar(3000) NOT NULL,
  `usertype` varchar(3000) NOT NULL,
  `gender` varchar(3000) NOT NULL,
  `birthyear` varchar(3000) NOT NULL,
  `Prediction` varchar(3000) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_predicting_bike_usage`
--

INSERT INTO `remote_user_predicting_bike_usage` (`id`, `Fid`, `trip_id`, `starttime`, `stoptime`, `bikeid`, `tripduration`, `from_station_id`, `from_station_name`, `to_station_id`, `to_station_name`, `usertype`, `gender`, `birthyear`, `Prediction`) VALUES
(1, '10.42.0.151-104.244.43.227-44705-443-6', '9080475', '3/31/2022 22:22', '3/31/2022 22:41', '3760', '1181', '318', 'Southport Ave & Irving Park Rd', '458', 'Broadway & Thorndale Ave', 'Subscriber', 'Female', '1979', 'More'),
(2, '203.130.53.126-10.42.0.211-80-48808-6', '9080381', '3/31/2022 21:44', '3/31/2022 22:03', '1381', '1140', '210', 'Ashland Ave & Division St', '503', 'Drake Ave & Fullerton Ave', 'Subscriber', 'Male', '1984', 'Less'),
(3, '10.42.0.211-10.42.0.1-19963-53-17', '9080133', '3/31/2022 20:53', '3/31/2022 20:59', '1664', '367', '239', 'Western Ave & Leland Ave', '472', 'Lincoln Ave & Winona St', 'Subscriber', 'Male', '1983', 'More'),
(4, '10.42.0.151-101.226.103.112-46206-80-6', '9077660', '3/31/2022 17:22', '3/31/2022 17:51', '2954', '1788', '286', 'Franklin St & Quincy St', '127', 'Lincoln Ave & Fullerton Ave', 'Subscriber', 'Female', '1968', 'Less');
